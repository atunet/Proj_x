...
local ITEMINFO_THISID_FIELD = protobuf.FieldDescriptor();
local ITEMINFO_ITEMID_FIELD = protobuf.FieldDescriptor();
local ITEMINFO_CREATETIME_FIELD = protobuf.FieldDescriptor();
local ITEMINFO_NUM_FIELD = protobuf.FieldDescriptor();
local ITEMNOTITYPE = protobuf.Descriptor();
local ITEMNOTITYPE_TYPE_FIELD = protobuf.FieldDescriptor();
local ITEMNOTITYPE_ITEMID_FIELD = protobuf.FieldDescriptor();
local ITEMNOTITYPE_COUNT_FIELD = protobuf.FieldDescriptor();
local ITEMCOUNTTYPE = protobuf.Descriptor();
local ITEMCOUNTTYPE_ITEMID_FIELD = protobuf.FieldDescriptor();
local ITEMCOUNTTYPE_COUNT_FIELD = protobuf.FieldDescriptor();
