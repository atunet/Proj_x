...
local SERVERTIMEREQ = protobuf.Descriptor();
local SERVERTIMEREQ_ID_FIELD = protobuf.FieldDescriptor();
local SERVERTIMERET = protobuf.Descriptor();
local SERVERTIMERET_ID_FIELD = protobuf.FieldDescriptor();
local SERVERTIMERET_SERVERTIME_FIELD = protobuf.FieldDescriptor();
local UTILSECHO = protobuf.Descriptor();
local UTILSECHO_ID_FIELD = protobuf.FieldDescriptor();
...
SERVERTIMEREQ_ID_FIELD.enum_type = BASETYPE_PB_EPROTOID
...
SERVERTIMERET_ID_FIELD.enum_type = BASETYPE_PB_EPROTOID
...
UTILSECHO_ID_FIELD.enum_type = BASETYPE_PB_EPROTOID
