...
QUESTTARGETBASE = protobuf.Descriptor();
QUESTTARGETBASE_TARGET_FIELD = protobuf.FieldDescriptor();
QUESTTARGETBASE_COUNT_FIELD = protobuf.FieldDescriptor();
QUESTINFOBASE = protobuf.Descriptor();
QUESTINFOBASE_QUEST_FIELD = protobuf.FieldDescriptor();
QUESTINFOBASE_COUNTER_FIELD = protobuf.FieldDescriptor();
QUESTINFOBASE_TYPE_FIELD = protobuf.FieldDescriptor();
QUESTRESOURCEREWARD = protobuf.Descriptor();
QUESTRESOURCEREWARD_KEY_FIELD = protobuf.FieldDescriptor();
QUESTRESOURCEREWARD_VALUE_FIELD = protobuf.FieldDescriptor();
QUESTITEMREWARD = protobuf.Descriptor();
QUESTITEMREWARD_KEY_FIELD = protobuf.FieldDescriptor();
QUESTITEMREWARD_VALUE_FIELD = protobuf.FieldDescriptor();
QUESTITEMREWARD_TYPE_FIELD = protobuf.FieldDescriptor();
