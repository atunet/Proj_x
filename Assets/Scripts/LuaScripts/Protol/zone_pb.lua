...
ZONE = protobuf.Descriptor();
ZONE_SERV_ID_FIELD = protobuf.FieldDescriptor();
ZONE_SERV_NAME_FIELD = protobuf.FieldDescriptor();
ZONE_REMOTE_IP_FIELD = protobuf.FieldDescriptor();
ZONE_PORT_FIELD = protobuf.FieldDescriptor();
ZONE_STATE_FIELD = protobuf.FieldDescriptor();
ZONE_RECOMMEND_FLAG_FIELD = protobuf.FieldDescriptor();
ZONE_PUBLISH_TIME_FIELD = protobuf.FieldDescriptor();
SIMPLEZONE = protobuf.Descriptor();
SIMPLEZONE_SERV_ID_FIELD = protobuf.FieldDescriptor();
SIMPLEZONE_SERV_NAME_FIELD = protobuf.FieldDescriptor();
GETZONELIST = protobuf.Descriptor();
GETZONELIST_ZONE_FIELD = protobuf.FieldDescriptor();
GETZONEINFO = protobuf.Descriptor();
GETZONEINFO_ZONE_FIELD = protobuf.FieldDescriptor();
GETROLELIST = protobuf.Descriptor();
GETROLELIST_ZONE_FIELD = protobuf.FieldDescriptor();
