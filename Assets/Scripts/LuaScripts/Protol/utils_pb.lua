...
SERVERTIMEREQ_ID_FIELD.default_value = SERVER_TIME_CS
SERVERTIMEREQ_ID_FIELD.enum_type = prototype_pb.EMESSAGEID
...
SERVERTIMERET_ID_FIELD.default_value = SERVER_TIME_SC
SERVERTIMERET_ID_FIELD.enum_type = prototype_pb.EMESSAGEID
...
UTILSECHO_ID_FIELD.enum_type = prototype_pb.EMESSAGEID
